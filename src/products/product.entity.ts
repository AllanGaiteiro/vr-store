...
export class Product {
  ...
  @ApiProperty({ description: 'Descrição do produto', example: 'Produto Exemplo', maxLength: 60 })
  ...
  @ApiProperty({ description: 'URL da imagem do produto', example: 'http://example.com/image.jpg', nullable: true })
